...
class PTBModel(object):
    ...
    def __init__(self, is_training, config):
        ...
        self._input_data = http://blog.csdn.net/u014595019/article/details/tf.placeholder(tf.int32, [batch_size, num_steps])    # 输入
...
if __name__=='__main__':
    ...
    raw_data = http://blog.csdn.net/u014595019/article/details/reader.ptb_raw_data(FLAGS.data_path) # 获取原始数据
